 ...
 * Horse
 *
 * @ORM\Table(name="horse", indexes={@ORM\Index(name="IDX_629A2F18D129B190", columns={"infrastructure"}), @ORM\Index(name="IDX_629A2F1898197A65", columns={"player"}), @ORM\Index(name="IDX_629A2F18F8AF884F", columns={"breed"})})
 * @ORM\Entity
 */
class Horse
{
