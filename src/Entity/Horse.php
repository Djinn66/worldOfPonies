...
class Horse
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Player", inversedBy="horses")
     * @ORM\JoinColumn(name="player", referencedColumnName="player_id")
     */
    private $player;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Infrastructure", inversedBy="horses")
     * @ORM\JoinColumn(name="infrastructure", referencedColumnName="infrastructure_id")
     */
    private $infrastructure;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Breed", inversedBy="horses")
     * @ORM\JoinColumn(name="breed", referencedColumnName="breed_id", nullable=false)
     */
    private $breed;
