 ...
 * Contest
 *
 * @ORM\Table(name="contest", indexes={@ORM\Index(name="IDX_1A95CB5D129B190", columns={"infrastructure"}), @ORM\Index(name="IDX_1A95CB53640243B", columns={"horseclub"}), @ORM\Index(name="IDX_1A95CB5C6E2E686", columns={"newspaper"})})
 * @ORM\Entity
 */
class Contest
{
