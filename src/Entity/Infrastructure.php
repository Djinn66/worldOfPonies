...
class Infrastructure
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Horse", mappedBy="infrastructure")
    ...
    public function removeHorse(Horse $horse): self
    {
        if ($this->horses->contains($horse)) {
            ...
            if ($horse->getInfrastructure() === $this) {
                $horse->setInfrastructure(null);
            }
        }
